// Copied from BetterCrewLink Desktop v3.2.2 (GPL-3.0), src/common/AmongusMap.
// https://github.com/OhMyGuus/BetterCrewLink — keep in sync when the upstream map data changes.
export enum MapType {
	THE_SKELD,
	MIRA_HQ,
	POLUS,
